...
export class ContactService extends BaseService {
   ...
   */
  static readonly FindAllByUserId1Path = '/contacts/user/{user-id}';
   ...
   */
  static readonly FindById2Path = '/contacts/contact/{contact-id}';
   ...
   */
  static readonly Delete2Path = '/contacts/contact/{contact-id}';
